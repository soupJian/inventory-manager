export class Api {
  ...
  async getAllInventory(params, headers) {
    return await fetch(
      ...
      if (resp.ok) return resp.json()
        ...
        return Promise.reject(resp).catch((error) =>
  ...
  async getSettledInventory(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/settled-inventory?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getUnsettledInventory(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/unsettled-inventory?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getAllProducts(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/all-products-inventory?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getMultipleProducts(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/products-skus?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getProduct(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/product-inventory?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getShippedOrders(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/shipped-orders?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async getUnShippedOrders(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/not-shipped-orders?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
  ...
  async search(params, headers) {
    return await fetch(
      `${Api.BASE_URL}/search-inventory?${params ? params : ''}`,
      {
        method: 'GET',
        headers: {
          ...headers,
