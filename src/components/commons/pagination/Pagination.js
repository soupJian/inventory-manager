          ...
          <Navigation>
            ...
            {totalPages <= 8 ? (
              [...new Array(totalPages)].map((_, idx) => (
                <PageNumber
                  onClick={() =>
                    currentPage === idx + 1 ? null : onPageChange(idx + 1)
                  }
              ...
              <>
                {currentPage > 6 ? (
                  <>
                    <PageNumber
                      onClick={() =>
                        currentPage === 1 ? null : onPageChange(1)
                      }
                      ...
                      <>
                        {[...new Array(5)].map((_, idx) => (
                          <PageNumber
                            ...
                            active={currentPage + idx === currentPage}
                          >
                            {currentPage + idx}
                          </PageNumber>
                        ))}
                      ...
                      <>
                        {[...new Array(6)].map((_, idx) => (
                          <PageNumber
                            key={idx + currentPage}
                            onClick={() =>
                              currentPage === totalPages - (5 - idx)
                                ? null
                                : onPageChange(totalPages - (5 - idx))
                            }
                            active={totalPages - (5 - idx) === currentPage}
                          >
                            {totalPages - (5 - idx)}
                          </PageNumber>
                        ))}
                      ...
                      <>
                        {[...new Array(6)].map((_, idx) => (
                          <PageNumber
                            ...
                            active={1 + idx === currentPage}
                          >
                            {1 + idx}
                          </PageNumber>
                        ))}
                        <PageNumber onClick={() => onPageChange(6 + 1)}>
                          ...
                        </PageNumber>
                        <PageNumber
                          onClick={() =>
...
const PrevButton = styled(PageButton)`
  ...
  & img {
    filter: ${({ disabled }) =>
      disabled
        ? 'invert(78%) sepia(1%) saturate(1656%) hue-rotate(3deg) brightness(79%) contrast(83%)'
        : 'none'};
  }
`
